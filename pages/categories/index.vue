...
// const category = ref<string>(route.params?.slug.toString() || '')
...
const banner = computed<Banner | null>(() => {
  if (commonStore.banners)
    return commonStore.banners[0] ?? null
  return null
})
  ...
  <main class="main">
    ...
    <div class="page-content mb-20">
      ...
      <div ref="bannerElement" class="banner-wrapper mb-12">
        <NuxtImg v-if="banner && banner.image" :src="banner.image" :alt="banner.image || 'Categories Banner'" />
        <div class="banner shop-default-banner shop-boxed-banner flex items-center">
          <div class="container banner-content">
            <h4 class="banner-subtitle">
              All Perfume Collection
            </h4>
        ...
        <div class="shop-content">
          ...
          <div class="main-content">
            ...
            <template v-if="filterProducts.length > 0">
              ...
              <!-- Start of Pagination -->
              <BasePaginations
                :total="totalProducts" :page-size="pageSize" :current-page="currentPage"
                :is-show-detail="true" @on-page-change="onPageChange"
              />
              <!-- End of Pagination -->
            </template>
            <template v-else>
